...
const GitHubIcon = () => (
  <svg viewBox="0 0 24 24" className="size-[18px] shrink-0" aria-hidden="true" fill="currentColor">
    ...
    <div className="grid grid-cols-2 gap-2.5">
      {providers.map(({ label, Icon, href }) => (
        ...
        >
          ...
          <span
            aria-hidden
            className="pointer-events-none absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-foreground/[0.04] to-transparent transition-transform duration-500 group-hover:translate-x-full"
          />
          <Icon />
          <span>{label}</span>
        </a>
